...
export const CALCULATOR_BUTTONS: ButtonConfig[] = [
  ...
  { label: 'MR', actionType: 'memory', styleType: 'memory', actionData: 'recall' },
  { label: 'M-', actionType: 'memory', styleType: 'memory', actionData: 'subtract' },
  { label: 'M+', actionType: 'memory', styleType: 'memory', actionData: 'add' },
  { label: 'C', actionType: 'clear', styleType: 'clear' },
  
  // Row 2: Numbers 7-9, Division, Reciprocal
  ...
  { label: '/', actionType: 'operation', styleType: 'default', actionData: 'divide' },
  { label: '1/x', actionType: 'unary', styleType: 'default', actionData: 'reciprocal' },
  
  // Row 3: Numbers 4-6, Multiplication, Clear Entry
  ...
  { label: '*', actionType: 'operation', styleType: 'default', actionData: 'multiply' },
  { label: 'CE', actionType: 'clearEntry', styleType: 'default' },
  
  // Row 4: Numbers 1-3, Subtraction, Sign Change
  ...
  { label: '-', actionType: 'operation', styleType: 'default', actionData: 'subtract' },
  { label: '±', actionType: 'unary', styleType: 'default', actionData: 'signchange' },
  
  // Row 5: Square root, 0, Decimal, Percent, Addition
  { label: 'sq', actionType: 'unary', styleType: 'default', actionData: 'sqroot' },
  { label: '0', actionType: 'digit', styleType: 'default', actionData: 0 },
  { label: '.', actionType: 'decimal', styleType: 'default' },
  { label: '%', actionType: 'unary', styleType: 'default', actionData: 'percentage' },
  ...
  return () => {
    switch (actionType) {
      ...
      case 'decimal':
        ...
        break;
      case 'operation':
        calculator.setAction(actionData as 'add' | 'subtract' | 'multiply' | 'divide');
        break;
      case 'unary':
        calculator.setAction(actionData as 'sqroot' | 'percentage' | 'reciprocal' | 'signchange');
        break;
      case 'memory':
        switch (actionData) {
          case 'clear':
